    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=50, unique=True, verbose_name="模块名称"),
                ),
                ...
                (
                    "url_pattern",
                    models.CharField(blank=True, max_length=200, verbose_name="URL模式"),
                ),
        ...
        migrations.AddField(
            ...
            name="employee_id",
            field=models.CharField(
                blank=True, max_length=50, null=True, verbose_name="工号"
            ),
        ),
        migrations.AddField(
            model_name="user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "qr_token",
                    models.CharField(max_length=64, unique=True, verbose_name="二维码令牌"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "scanned_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="扫码时间"),
                ),
                (
                    "confirmed_at",
